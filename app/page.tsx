    ...
    <div className="flex flex-col h-full" style={{ background: "var(--background)" }}>
      ...
      <footer className="bg-white border-t border-gray-100 px-4 py-3 flex-shrink-0 shadow-[0_-2px_8px_rgba(0,0,0,0.04)]">
        ...
        >
          <div className="flex-1">
            <textarea
              ...
              disabled={isLoading}
              rows={1}
              className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent resize-none leading-relaxed bg-gray-50 placeholder-gray-400 transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          ...
          <button
            ...
            className="flex-shrink-0 w-10 h-10 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors flex items-center justify-center shadow-sm"
        ...
        <p className="max-w-3xl mx-auto mt-1.5 text-xs text-gray-400 text-center">
          PRD-Bot asks questions until it has everything needed to write your requirements document.
        </p>
      </footer>
    </div>
  );
